  ...
  return (
    <div className="card grid">
      ...
      {!loading && items.length === 0 && (
        <div className="small">No links yet. Create some on the Shortener page.</div>
      )}
      ...
      {items.map(({ link, stats, error }, idx) => (
        <div key={idx} className="grid">
          ...
          {stats && (
            <>
             <div className="small">
  Original: <span className="original-url">{stats.originalUrl}</span>
</div>
              ...
              <div>Total Clicks: <b>{stats.totalClicks}</b></div>
              ...
              <table className="table">
                ...
                <tbody>
                  {stats.clicks.length === 0 && (
                    <tr>
                      <td colSpan="3" className="small" style={{ textAlign: "center" }}>No clicks yet.</td>
                    </tr>
                  )}
